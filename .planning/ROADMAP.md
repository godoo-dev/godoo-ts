...
- [ ] 02-03-PLAN.md — Re-enable client integration tests against @godoo/testcontainers + new `integration` CI job (Node 22+24) + update require-ci-on-main ruleset to require new checks (CORE-03)
