...
import type { JsonRpcRequest, JsonRpcResponse, OdooSessionInfo, RpcArg } from './types';

// Re-export types for convenience
export type { JsonRpcRequest, JsonRpcResponse, OdooSessionInfo };
...
export class JsonRpcTransport {
   ...
   */
  async callRpc<T = unknown>(method: string, params: Record<string, unknown>): Promise<T> {
