...
// TODO(02-01 whitelist): examples/ directory excluded from adoption copy per Plan
// 02-01 Task 1 whitelist; this meta-test cannot run until examples are restored in
// a later phase. Tracked as a Phase-2/3 follow-up.
