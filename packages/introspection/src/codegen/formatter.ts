...
// Reference `Domain` at module scope so the typed import is preserved past
// `tsc --noEmit` and Biome's organize-imports pass. The generated user code
// emitted by `generateHelperTypes()` references `Domain` in the `SearchOptions`
// interface; this re-export documents that contract.
export type { Domain };
...
export function generateCompleteFile(allMetadata: ModelMetadata[]): string {
  ...
  lines.push(' * ');
  lines.push(' * This file is generated by @odoo-introspection/codegen from live Odoo metadata.');
