...
} from '../src/codegen/formatter.js';
import {
  generateFieldJSDoc,
  getFieldTypeExpression,
  isWritableField,
  mapFieldType,
} from '../src/codegen/type-mappers.js';
import type { ModelMetadata, OdooField } from '../src/introspection/types.js';
...
describe('Code Formatter', () => {
  ...
  describe('generateHelperTypes', () => {
    it('generates SearchOptions interface', () => {
      ...
      expect(code).toContain('domain?: Domain');
    ...
    it('generates ReadOptions interface', () => {
      ...
      expect(code).toContain('context?: Record<string, unknown>');
    });
