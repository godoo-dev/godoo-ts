...
// TODO: enable introspection integration tests in a follow-up phase — no Phase-2 requirement covers them.
// Skipped in Phase 2 per RESEARCH.md Open Question 3 RESOLVED — running this
// suite requires extending the integration CI job to include introspection,
// which broadens scope. The test is preserved for future activation.
describe.skip('odoo-introspection examples', () => {
